...
zip -r -FS extension_firefox.zip * --exclude '*.git*' --exclude 'README*' --exclude '*.zip' --exclude '*.sh' --exclude '*test*' --exclude '*dist*' --exclude '*manifest.*.json'
...
zip -r -FS extension_chromium.zip * --exclude '*.git*' --exclude 'README*' --exclude '*.zip' --exclude '*.sh' --exclude '*test*' --exclude '*dist*' --exclude '*katex/fonts/*' --exclude '*manifest.*.json'
